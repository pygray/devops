...
<script>
import { getGroupsList, addRole, getGroupPermissionsList, deleteGroup, getGroupMenuList, updateGroupMenu, getGroupMembers, deleteGroupMember, deleteGroupPermissions, updateGroupPermissions } from '@/api/account'
export default {
  data() {
    return {
      groupList: [],
